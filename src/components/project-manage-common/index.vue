<template>
  <div>
    ...
    <div class="button">
      <el-button @click="this.$router.push('project-common-newItem')" plain>新建立项</el-button>
    </div>
    <el-divider></el-divider>


    <el-table :data="tableData" style="width: 100%" :default-sort="{ prop: 'defaultTime', order: 'descending' }">
      ...
      <el-table-column label="操作">
        <template #default="scope">
          <el-button @click="pushToItem(scope.$index, scope.row)">打开</el-button>
        </template>
      </el-table-column>
    </el-table>
    <div class="example-pagination-block">
      <div class="example-demonstration"></div>
      <el-pagination :page-sizes="[10, 20, 30, 40, 50, 100]" layout="prev, pager, next, jumper,sizes, ->, total"
        :total="page.total" :default-page-size="20" @current-change="currentChange" @size-change="sizeChange" />
    </div>
  </div>
</template>
